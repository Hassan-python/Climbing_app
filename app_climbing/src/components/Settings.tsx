              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleApiKeyChange('geminiApiKey')}
                ...
                <div>
                  <label className="block text-xs text-gray-500 mb-1">
                    {t('settings.apiKeys.openai')}
                  </label>
                  <input
                    type="password"
                    value={apiKeys.openaiApiKey}
                    onChange={handleApiKeyChange('openaiApiKey')}
                    className="w-full text-sm rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500"
                ...
                <div>
                  <label className="block text-xs text-gray-500 mb-1">
                    {t('settings.apiKeys.model')}
                  </label>
                  <input
                    type="text"
                    value={apiKeys.openaiModel}
                    onChange={handleApiKeyChange('openaiModel')}
                    className="w-full text-sm rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500"
                    placeholder="gpt-4"
                  />
                </div>
